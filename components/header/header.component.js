...
export const Header = props => {
  ...
  return (
    <header
      role="banner"
      className="mh-header-hover mh-default-z-index svelte-11vrfk0"
    >
      <div className="mh-container svelte-11vrfk0">
        <div className="mh-brand-wrapper svelte-11vrfk0">
          <a
            href="https://www.spotify.com/fr/"
            className="mh-header-primary svelte-18o1xvt"
            data-tracking='{"category": "menu", "action": "spotify-logo"}'
          >
            <span className="mh-header-primary svelte-1gcdbl9">
              <svg
                viewBox="0 0 63 20"
        ...
        <nav role="navigation" className="mh-desktop svelte-4ldyho">
          <ul className="svelte-4ldyho">
            <li className="svelte-yew4z8">
              <a
                href="https://www.spotify.com/fr/premium/?checkout=false"
                className="mh-header-primary svelte-yew4z8"
            ...
            <li role="separator" className="mh-header-primary svelte-1wung5m"></li>
            <li className="svelte-yew4z8">
              <a
                href="https://www.spotify.com/fr/signup/"
                className="mh-header-secondary svelte-yew4z8"
            ...
            <li className="svelte-yew4z8">
              <a
                href="https://www.spotify.com/fr/account/overview/"
                className="mh-header-secondary svelte-yew4z8"
        ...
        <div className="mh-mobile-menu svelte-4ldyho">
          <button
            type="button"
            role="menu"
            className="mh-header-primary svelte-v64zdx mh-menu-closed"
          >
            <span className="mh-sr-only svelte-v64zdx">Toggle navigation</span>
            <span className="mh-icon-bar svelte-v64zdx"></span>
            <span className="mh-icon-bar svelte-v64zdx"></span>
            <span className="mh-icon-bar svelte-v64zdx"></span>
          </button>
        </div>
